...
export class EmailService {
  ...
  private async sendTemplate(to: string, content: EmailContent): Promise<void> {
    ...
    const replyTo =
      this.config.get<string>('MAIL_REPLY_TO') || 'support@matchena.com';
