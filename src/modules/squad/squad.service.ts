...
export class SquadService {
  ...
  async invite(fromUserId: string, toUserId: string) {
    ...
    // notifications.create() below emits its own 'notification.created' socket
    // event, which the client already treats as a live-update trigger — a
    // separate 'squad.invite.created' emit here would fire a second, redundant
    // refresh for the same invite.
